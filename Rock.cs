...
namespace Music_Player.Classes
{
    public class Rock : Music
    {
        ...
        private string[] lines = System.IO.File.ReadAllLines(@"C:\Users\dikla\OneDrive\שולחן העבודה\לימודים מדמח HIT\שנה א\קיץ\מונחה\Final Project\Rock_Songs\Songs.txt");
        private int i = 0,j=0;
        public Rock()
        {
        ...
        private LinkedList<Rock> songs = new LinkedList<Rock>();
        public LinkedList<Rock> Songs
        {
            get { return songs; }
